...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        MainWindow.resize(734, 513)
        self.centralwidget = QtWidgets.QWidget(MainWindow)
        self.centralwidget.setObjectName("centralwidget")
        self.gridLayout = QtWidgets.QGridLayout(self.centralwidget)
        self.gridLayout.setObjectName("gridLayout")
        self.labelLargura = QtWidgets.QLabel(self.centralwidget)
        self.labelLargura.setObjectName("labelLargura")
        self.gridLayout.addWidget(self.labelLargura, 4, 0, 1, 1)
        ...
        self.scrollAreaWidgetContents.setGeometry(QtCore.QRect(0, 0, 714, 406))
        ...
        self.gridLayout.addWidget(self.labelAltura, 4, 2, 1, 1)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.labelLargura.setText(_translate("MainWindow", "Largura"))
